...
def welcome(message):
    bot.send_message(message.chat.id,f"<b>Assalomu alaykum {message.from_user.first_name} ! \n\nMen 🎵 Tik-Tok &🔥 Instagram dan video yuklayman!\n\n Link yuboring !\n\n\n Reklama : @Clone_izdoshi va @UlugbekCoder ga azo boling</b>",parse_mode='html')
    try:
